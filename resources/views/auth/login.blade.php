                        ...
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="form-group">
                                <div class="input-group mb-3">
                                    ...
                                    <input id="email" name="email" type="email" class="form-control pl-15 bg-transparent text-white plc-white" value="{{old('email')}}" required autofocus placeholder="Email Address">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="input-group mb-3">
                                    ...
                                    <input id="password" name="password" type="password" class="form-control pl-15 bg-transparent text-white plc-white" required autocomplete="current-password" placeholder="Password">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-6">
